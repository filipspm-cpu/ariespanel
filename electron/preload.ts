...
const api = {
  ...
  clickerSet: (payload: { enabled: boolean; intervalMs: number; button?: "left" | "right" | "middle" }) =>
  ...
  profileSaveName: (name: string) => ipcRenderer.invoke("profile:saveName", name),
  forumAsk: (payload: { question: string; passages: unknown[] }) => ipcRenderer.invoke("forum:ask", payload),
