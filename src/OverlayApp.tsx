...
function SpotifyWidget({ track }: { track: SpotifyTrack | null }) {
  ...
  return (
    <div className="flex w-[240px] items-center gap-2 rounded-xl bg-black/85 px-2.5 py-1.5">
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-[#1db954] text-black">
